...
# $Header: /var/cvsroot/gentoo-x86/dev-python/pywebkitgtk/pywebkitgtk-1.1.6.ebuild,v 1.1 2009/08/29 02:25:11 arfrever Exp $
...
src_install() {
	...
	# fix webkit importing
	mkdir -p ${D}/usr/$(get_libdir)/python${PYVER}/site-packages/
	echo "webkit-1.0" > ${D}/usr/$(get_libdir)/python${PYVER}/site-packages/webkit.pth
